...
<div class="container-scroller">
  ...
  <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a class="navbar-brand brand-logo mr-5" href="show-home-editor.php"><img src="src/images/corazon.png" class="mr-" alt="logo" /></a>
      <a class="navbar-brand brand-logo-mini" href="show-home-editor.php"><img src="src/images/corazon.png" alt="logo" /></a>
    </div>
  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <div class="fs-2 mb-3">
        ...
        <li class="nav-item">
          <a class="nav-link" href="show-home-editor.php">
