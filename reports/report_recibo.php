...
$objPdf->SetTextColor(75,73,172);
$objPdf->Cell(150,9,utf8_decode("REPORTE DE RECIBOS"),0,0,'L');
...
$objPdf->Cell(40,8,utf8_decode("Nombre del Paciente"),1,0,'C',true);
$objPdf->Cell(40,8,utf8_decode("Apellido del Paciente"),1,0,'C',true);
$objPdf->Cell(20,8,utf8_decode("Cargo"),1,0,'C',true);
$objPdf->Cell(20,8,utf8_decode("Nro. Recibo"),1,0,'C',true);
$objPdf->Cell(40,8,utf8_decode("Fecha"),1,0,'C',true);
$objPdf->Cell(20,8,utf8_decode("Precio USD"),1,0,'C',true);
$objPdf->Cell(50,8,utf8_decode("Concepto"),1,0,'C',true);
;
...
while($fila = $recibos->fetch_assoc()) {
$objPdf->Cell(10, 7, utf8_decode($fila['id_recibo']),'L',0,'C');
$objPdf->Cell(40, 7,utf8_decode($fila['nombre']),'L',0,'C');
$objPdf->Cell(40, 7,utf8_decode($fila['apellido']),'L',0,'C');

/*Funcion de la clase FPDF Cellfit para truncar*/
/* 	$objCell->CellFitScale(20, 7,utf8_decode($fila['apellido']),'L',0,'C'); */
 $objPdf->Cell(20, 7,utf8_decode($fila['cargo']),'L',0,'C');
 $objPdf->Cell(20, 7, utf8_decode($fila['numero_recibo']),'L',0,'C');
$objPdf->Cell(40, 7, utf8_decode($fila['fecha']),'L',0,'C');
$objPdf->Cell(20, 7, utf8_decode($fila['precio']),'L',0,'C');
$objPdf->Cell(50, 7, utf8_decode($fila['concepto']),'L',0,'C');
